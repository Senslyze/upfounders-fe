          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 items-start">
            ...
            <div className="space-y-5 px-0 md:px-4">
              ...
              <div className="space-y-4">
                <Link to="/" className="group flex items-center text-gray-700 hover:text-blue-600 transition-all duration-200">
                  <span className="font-medium group-hover:translate-x-1 transition-transform">Directory</span>
                </Link>
                <Link to="/compare" className="group flex items-center text-gray-700 hover:text-blue-600 transition-all duration-200">
                  <span className="font-medium group-hover:translate-x-1 transition-transform">Compare Partners</span>
                </Link>
                <Link to="/resources" className="group flex items-center text-gray-700 hover:text-blue-600 transition-all duration-200">
                  <span className="font-medium group-hover:translate-x-1 transition-transform">Resources</span>
                </Link>
                <Link to="/newsletter" className="group flex items-center text-gray-700 hover:text-blue-600 transition-all duration-200">
